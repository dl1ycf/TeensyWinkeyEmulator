...
#define MYSERIAL                    // use standard serial connection (1200 baud) for Winkey protocol
...
//
// Note that the default settings for side tone frequency and volume, and for
// the master volume are irrelevant if there are pots to adjust them, since
// they will be overwritten upon first reading of the pot. These settings are
// included here if there is only one pot (for the cw speed).
////////////////////////////////////////////////////////////////////////////
